...
func WithRestoreImage(ctx context.Context, id string, client *Client, checkpoint Image, index *imagespec.Index, sbID string) NewContainerOpts {
	return func(ctx context.Context, client *Client, c *containers.Container) error {
		...
		if sbID != "" {
			snapshotInfoLabels[snapshots.LabelSnapshotExtraRWPath] = sbID + "," + id
		}
